...
# core_mut_rate <- fread(paste0(outdir_dat, "/core_mut_rate.csv"))[3,]$mean_pi_s
...
fwrite(prob_pi, file.path(outdir_dat, "prob_pi_norm.csv"))
...
fwrite(pi_prod_lng, file.path(outdir_dat, "pi_prod_lng.csv"))
...
fwrite(pi_ci_bounds, paste0(outdir_dat, "/ci_summary.csv"))
