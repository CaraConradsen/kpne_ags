...
core_tree <- read.tree("./input_data/bootstrapped_pangraph_gubbins/boot_gub_pang_100.final_bootstrapped_tree.tre")
...
system2("Rscript",
        args = c("./analysis/07_hgt_synteny_parsimony_ag_sets/run_homoplasy.R",
                 presenceAbsenceFile,
                 treeFile,
